...
--
-- Servidor: localhost
-- Tiempo de generación: 02-12-2025 a las 10:59:16
...
--
ALTER TABLE `aulas`
  MODIFY `id_aula` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=68;
...
--
ALTER TABLE `horario_lectivo`
  MODIFY `id_horario` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2547;
...
ALTER TABLE `horario_lectivo`
  ...
  ADD CONSTRAINT `horario_lectivo_ibfk_2` FOREIGN KEY (`usuario`) REFERENCES `usuarios` (`id_usuario`) ON DELETE NO ACTION ON UPDATE CASCADE,
  ADD CONSTRAINT `horario_lectivo_ibfk_3` FOREIGN KEY (`grupo`) REFERENCES `grupos` (`id_grupo`) ON DELETE NO ACTION ON UPDATE CASCADE;
COMMIT;
